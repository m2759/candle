      ...
      useGetCurrentEpochId,
       ...
       useGetEpochPrice0,
        useGetEpochPrice,
         ...
         useGetEpochPrice10,
         useGetEpochPriceLTC,
         useGetCurrentPriceLTC
         } from "../hooks";
import { formatEther } from "@ethersproject/units"
import ltclogo from "../Pictures/ltclogo.png"
...
export const TableLTC = () =>{
    ...
    const XGetCurrentPrice = useGetCurrentPriceLTC()


    const Getethprice = useGetEpochPriceLTC(0)
    ...
    const GetEpochPrice = useGetEpochPriceLTC(1)
    const XGetEpochPrice0 = useGetEpochPriceLTC(0)
    const XGetEpochPrice2 = useGetEpochPriceLTC(2)
    const XGetEpochPrice3 = useGetEpochPriceLTC(3)
    const XGetEpochPrice4 = useGetEpochPriceLTC(4)
    const XGetEpochPrice5 = useGetEpochPriceLTC(5)
    const XGetEpochPrice6 = useGetEpochPriceLTC(6)
    const XGetEpochPrice7 = useGetEpochPriceLTC(7)
    const XGetEpochPrice8 = useGetEpochPriceLTC(8)
    const XGetEpochPrice9 = useGetEpochPriceLTC(9)
    const XGetEpochPrice10 = useGetEpochPriceLTC(10)
        ...
        <Box bg="gray.800"
            ...
            <HStack spacing="35">
                ...
                <Box bg="gray.800"
                    ...
                    <Img src ={ltclogo} boxSize="25px" position="relative" bottom="1px" left="8px" top="1px"></Img>
                    </Center>
                </Box>
                <Box bg="gray.800"
                 height="30px"
