...
const ENDPOINT = "http://ggoodwork.com/api/chartltc";

let chart = createChart(document.getElementById("xx3"), { 
    width: 375, 
    height: 300,
    rightPriceScale:{
        scaleMargins:{}
        ...
        <Center>
            ...
            <VStack>
                <Box boxShadow="dark-lg" height="305px" width="382px"  border="1px" borderColor="gray.700" bg="#131722" borderRadius="md" position = "relative" bottom="30px" >
                    <Tooltip label={"Litecoin price feed (3 minutes)"} placement='right'>
