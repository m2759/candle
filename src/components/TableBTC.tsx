...
import { Box, Center, Button, Input, Stack, Text, HStack, Flex, VStack, Img,CircularProgress,} from "@chakra-ui/react"
import { useTotalUp,
     useTotalDown,
...
import btclogo from "../Pictures/bitcoin-btc-logo.png"
import CountUp from 'react-countup';

declare let window: any;


export const TableBTC = () =>{
    //server test  
    ...
    const GetEpochPrice = useGetEpochPrice()
    const XGetEpochPrice0 = useGetEpochPrice0()
    const XGetEpochPrice2 = useGetEpochPrice2()
    const XGetEpochPrice3 = useGetEpochPrice3()
    const XGetEpochPrice4 = useGetEpochPrice4()
    const XGetEpochPrice5 = useGetEpochPrice5()
    const XGetEpochPrice6 = useGetEpochPrice6()
    const XGetEpochPrice7 = useGetEpochPrice7()
    const XGetEpochPrice8 = useGetEpochPrice8()
    const XGetEpochPrice9 = useGetEpochPrice9()
    const XGetEpochPrice10 = useGetEpochPrice10()
        ...
        <Box bg="gray.800"
            ...
            <HStack spacing="35">
                ...
                <Box bg="gray.800"
                    ...
                    <Text fontWeight="bold" color="gray.400" position="relative" left="10px" >
                    Price
                    </Text>
                    <Img src ={btclogo} boxSize="25px" position="relative" bottom="1px" left="15px" top="1px"></Img>
                    </Center>
                </Box>
                <Box bg="gray.800"
                 height="30px"
            ...
            >
                <HStack position="relative" top="7px" left="20px" spacing="42" >
                    ...
                    <Box height="30px" width="90px" position="relative" left="3px" bottom="3px">
                        ...
                        <Text fontWeight="bold" color={colorOfText1()} fontSize={14} position="relative" left="14px">
